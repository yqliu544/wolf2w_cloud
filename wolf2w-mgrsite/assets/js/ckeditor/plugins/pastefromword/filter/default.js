...
(function () {
    ...
    var f, k, t, p, m = CKEDITOR.tools, y = ["o:p", "xml", "script", "meta", "link"],
        z = "v:arc v:curve v:line v:oval v:polyline v:rect v:roundrect v:group".split(" "), w = {},
        v = 0;
    ...
    CKEDITOR.cleanWord = function (a, b) {
        ...
        var g = CKEDITOR.htmlParser.fragment.fromHtml(a), h = {
            root: function (a) {
                a.filterChildren(p);
            ...
            elements: {
                ...
                h1: function (a) {
                    ...
                    var c = a.getAscendant("table"), d = c._tdBorders,
                        e = ["border", "border-top", "border-right", "border-bottom", "border-left"],
                        c = m.parseCssText(c.attributes.style), g = c.background || c.BACKGROUND;
                    ...
                    var b = !1;
                    if (null === a.getFirst("v:imagedata")) c(a); else {
            ...
            attributes: {
                style: function (a, c) {
                    ...
                    return "" === a ? !1 : a
                }, cellspacing: u, cellpadding: u, border: u,
                "v:shapes": u, "o:spid": u
            },
            comment: function (a) {
    ...
    CKEDITOR.plugins.pastefromword.styles =
        {
            setStyle: function (a, b, c, d) {
                ...
                var c = "background-color:transparent border-image:none color:windowtext direction:ltr mso- text-indent visibility:visible div:border:none".split(" "),
                    ...
                    }, g = b && !0 === b.config.pasteFromWordRemoveFontStyles, h = m.parseCssText(a.attributes.style);
                ...
                for (var l = m.objectKeys(h),
                         q = 0; q < l.length; q++) {
                    var n = l[q].toLowerCase(), r = h[l[q]], k = CKEDITOR.tools.indexOf;
                ...
                var g =
                    "span" === a.name, h;
                for (h in b) if (!h.match(d || /margin|text\-align|width|border|padding/i)) if (g) g = !1; else {
                ...
                var d = {"list-style-type": !0, width: !0, height: !0, border: !0, "border-": !0},
                    e = m.parseCssText(a.attributes.style), g;
                for (g in e) if (!(g.toLowerCase() in
                ...
                parse: function (a) {
                    ...
                    var d = CKEDITOR.tools.parseCssText, e = CKEDITOR.plugins.pastefromword.styles.inliner.filter,
                        g = a.is ? a.$.sheet : b(a);
                    a = [];
                    var h;
                    if (g) for (g = g.cssRules, h = 0; h < g.length; h++) g[h].type ===
                    window.CSSRule.STYLE_RULE && a.push({selector: g[h].selectorText, styles: e(c(g[h].cssText))});
                    return a
                }, filter: function (a) {
                    ...
                    var b = CKEDITOR.plugins.pastefromword.styles.inliner.parse,
                        c = CKEDITOR.plugins.pastefromword.styles.inliner.sort, d = function (a) {
    ...
    CKEDITOR.plugins.pastefromword.lists = {
        ...
        setListSymbol: function (a, b, c) {
            ...
            if ("ol" == a.name) {
                ...
                for (g in e) if (f.getSubsectionSymbol(b).match(new RegExp(g))) {
            ...
            toNumber: function (a, b) {
                ...
                function d(a) {
                    ...
                    a = a.toUpperCase();
                    for (var c = b.length, d = 0, f = 0; f < c; ++f) for (var n = b[f], r = n[1].length; a.substr(0, r) == n[1]; a = a.substr(r)) d += n[0];
                    return d
                }
            ...
            for (a = 0; a < g.length; a++) {
                ...
                var l = [f.createList(l)], k = l[0], n = [l[0]];
                k.insertBefore(h[0]);
                for (d = 0; d < h.length; d++) {
                    b = h[d];
                    for (c = b.attributes["cke-list-level"]; c > l.length;) {
                        var r = f.createList(b), m = k.children;
                        0 < m.length ? m[m.length -
                        1].add(r) : (m = new CKEDITOR.htmlParser.element("li", {style: "list-style-type:none"}), m.add(r), k.add(m));
                        l.push(r);
                        n.push(r);
                        k = r;
            ...
            g.forEach(n, function (a) {
                var h = a.attributes.type, f = parseInt(a.attributes.start, 10) || 1, l = c(e, a) + 1;
            ...
            for (var c = {}, d = [[]], e, g = 0; g < a.length; g++) {
                var h = c[a[g].attributes["cke-list-level"]], l = this.getListItemInfo(a[g]), k, n;
    ...
    CKEDITOR.plugins.pastefromword.images = {
        extractFromRtf: function (a) {
            var b = [], c = /\{\\pict[\s\S]+?\\bliptag\-?\d+(\\blipupi\-?\d+)?(\{\\\*\\blipuid\s?[\da-fA-F]+)?[\s\}]*?/,
                d;
            a = a.match(new RegExp("(?:(" + c.source + "))([\\da-fA-F\\s]+)\\}", "g"));
            if (!a) return b;
            for (var e = 0; e < a.length; e++) if (c.test(a[e])) {
                if (-1 !== a[e].indexOf("\\pngblip")) d = "image/png"; else if (-1 !== a[e].indexOf("\\jpegblip")) d = "image/jpeg"; else continue;
                b.push({
